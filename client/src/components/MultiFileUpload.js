          ...
          {files.length > 0 && (
            <SummaryConfig 
              ...
              totalPages={files.reduce((total, file) => {
                // Much better estimate for PDFs: typically 1 page per 50KB-100KB
                // Use 60KB as middle ground for more accurate estimates
                const estimatedPages = Math.ceil(file.size / 60000);
